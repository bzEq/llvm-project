...
; CHECK-EMPTY:
; CHECK-NEXT:    #NO_APP
; CHECK-NEXT:    ld 3, 0(27)
; CHECK-NEXT:    std 3, 0(28)
...
; CHECK-NO-ISEL-NEXT:    mr 30, 3
; CHECK-NO-ISEL-NEXT:    lbz 3, 295(1)
...
; CHECK-NO-ISEL-NEXT:    bc 12, 8, .LBB0_21
...
; CHECK-NO-ISEL-NEXT:    ld 3, 0(27)
; CHECK-NO-ISEL-NEXT:    std 3, 0(28)
...
; CHECK-NO-ISEL-NEXT:    li 29, -5
; CHECK-NO-ISEL-NEXT:  .LBB0_21: # %while.end418
; CHECK-NO-ISEL-NEXT:    bc 12, 8, .LBB0_23
; CHECK-NO-ISEL-NEXT:  # %bb.22: # %if.then420
; CHECK-NO-ISEL-NEXT:    extsw 4, 29
; CHECK-NO-ISEL-NEXT:    mr 3, 30
; CHECK-NO-ISEL-NEXT:    bl jbd2_journal_abort
; CHECK-NO-ISEL-NEXT:    nop
; CHECK-NO-ISEL-NEXT:  .LBB0_23: # %if.end421
; CHECK-NO-ISEL-NEXT:  .LBB0_24: # %if.then.i1296
; CHECK-NO-ISEL-NEXT:  .LBB0_25: # %if.then5
; CHECK-NO-ISEL-NEXT:  .LBB0_26: # %do.body.i
; CHECK-NO-ISEL-NEXT:  .LBB0_27: # %do.body5.i1122
