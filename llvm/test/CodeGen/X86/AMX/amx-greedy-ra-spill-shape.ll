...
define void @foo(i32 %M, i32 %N, i32 %K, ptr %A, ptr %B_rcr4, ptr %C, i32 %c_row_from, i32 %c_row_to, i32 %c_row_tile, i32 %c_col_from, i32 %c_col_to, i32 %c_col_tile) {
  ...
  ; CHECK-NEXT:   MOV64mr %stack.12, 1, $noreg, 0, $noreg, $r8 :: (store (s64) into %stack.12)
  ; CHECK-NEXT:   MOV64mr %stack.1, 1, $noreg, 0, $noreg, $rcx :: (store (s64) into %stack.1)
  ; CHECK-NEXT:   undef [[COPY1:%[0-9]+]].sub_32bit:gr64_with_sub_8bit = COPY $edx
  ; CHECK-NEXT:   undef [[COPY2:%[0-9]+]].sub_32bit:gr64_nosp = COPY $esi
  ...
  ; CHECK-NEXT:   [[LEA64_32r:%[0-9]+]]:gr32 = LEA64_32r [[COPY1]], 1, $noreg, 63, $noreg
  ; CHECK-NEXT:   TEST32rr [[COPY1]].sub_32bit, [[COPY1]].sub_32bit, implicit-def $eflags
  ; CHECK-NEXT:   [[LEA64_32r:%[0-9]+]]:gr32 = CMOV32rr [[LEA64_32r]], [[COPY1]].sub_32bit, 9, implicit $eflags
  ...
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:gr32 = COPY [[COPY1]].sub_32bit
  ; CHECK-NEXT:   MOV16mr %stack.0, 1, $noreg, 18, $noreg, [[COPY3]].sub_16bit :: (store (s512) into %stack.0 + 18, align 2, basealign 4)
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:gr32 = SUB32rr [[COPY3]], [[LEA64_32r]], implicit-def dead $eflags
  ; CHECK-NEXT:   MOV16mr %stack.0, 1, $noreg, 18, $noreg, [[COPY3]].sub_16bit :: (store (s512) into %stack.0 + 18, align 2, basealign 4)
  ; CHECK-NEXT:   [[MOVZX32rr16_:%[0-9]+]]:gr32 = MOVZX32rr16 [[COPY3]].sub_16bit
  ...
  ; CHECK-NEXT:   [[MOVSX64rr32_:%[0-9]+]]:gr64 = MOVSX64rr32 [[COPY1]].sub_32bit
  ; CHECK-NEXT:   MOV64mr %stack.2, 1, $noreg, 0, $noreg, [[MOVSX64rr32_]] :: (store (s64) into %stack.2)
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]].sub_32bit:gr64_with_sub_8bit = SUB32rr [[COPY1]].sub_32bit, [[COPY3]], implicit-def dead $eflags
  ; CHECK-NEXT:   undef [[MOVZX32rr16_1:%[0-9]+]].sub_32bit:gr64_with_sub_8bit = MOVZX32rr16 [[COPY1]].sub_16bit
  ; CHECK-NEXT:   ADD64mr %stack.1, 1, $noreg, 0, $noreg, [[MOVZX32rr16_1]], implicit-def dead $eflags :: (store (s64) into %stack.1)
  ; CHECK-NEXT:   undef [[COPY4:%[0-9]+]].sub_32bit:gr64_with_sub_8bit = COPY [[MOVZX32rr16_1]].sub_32bit
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]].sub_32bit:gr64_with_sub_8bit = IMUL32rr [[COPY4]].sub_32bit, [[COPY2]].sub_32bit, implicit-def dead $eflags
  ; CHECK-NEXT:   [[LEA64_32r2:%[0-9]+]]:gr32 = LEA64_32r $noreg, 4, [[COPY2]], 0, $noreg
  ; CHECK-NEXT:   [[MOVSX64rr32_1:%[0-9]+]]:gr64 = MOVSX64rr32 [[LEA64_32r2]]
  ; CHECK-NEXT:   [[MOVSX64rr32_2:%[0-9]+]]:gr64_nosp = MOVSX64rr32 [[COPY2]].sub_32bit
  ...
  ; CHECK-NEXT:   MOV64mr %stack.4, 1, $noreg, 0, $noreg, [[MOVSX64rm32_1]] :: (store (s64) into %stack.4)
  ; CHECK-NEXT:   [[MOVSX64rr32_4:%[0-9]+]]:gr64 = MOVSX64rr32 [[MOV32rm1]]
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:gr32 = COPY [[MOV32rm3]]
  ; CHECK-NEXT:   [[MOVSX64rr32_5:%[0-9]+]]:gr64 = MOVSX64rr32 [[COPY5]]
  ; CHECK-NEXT:   [[MOVSX64rr32_6:%[0-9]+]]:gr64 = MOVSX64rr32 [[MOV32rm]]
  ; CHECK-NEXT:   MOV64mr %stack.7, 1, $noreg, 0, $noreg, [[MOVSX64rr32_6]] :: (store (s64) into %stack.7)
  ; CHECK-NEXT:   MOV64mr %stack.5, 1, $noreg, 0, $noreg, [[MOVSX64rr32_4]] :: (store (s64) into %stack.5)
  ...
  ; CHECK-NEXT:   MOV64mr %stack.8, 1, $noreg, 0, $noreg, [[LEA64r]] :: (store (s64) into %stack.8)
  ; CHECK-NEXT:   MOV64mr %stack.6, 1, $noreg, 0, $noreg, [[MOVSX64rr32_5]] :: (store (s64) into %stack.6)
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]]:gr64 = COPY [[MOVSX64rr32_5]]
  ...
  ; CHECK-NEXT:   MOV64mr %stack.3, 1, $noreg, 0, $noreg, [[MOVSX64rm32_]] :: (store (s64) into %stack.3)
  ; CHECK-NEXT:   [[LEA64_32r3:%[0-9]+]]:gr32 = LEA64_32r [[COPY4]], 4, [[MOVSX64rm32_]], 0, $noreg
  ...
  ; CHECK-NEXT:   [[MOV64rm1:%[0-9]+]]:gr64 = IMUL64rm [[MOV64rm1]], %stack.2, 1, $noreg, 0, $noreg, implicit-def dead $eflags :: (load (s64) from %stack.2)
  ; CHECK-NEXT:   [[MOV64rm1:%[0-9]+]]:gr64 = ADD64rm [[MOV64rm1]], %stack.1, 1, $noreg, 0, $noreg, implicit-def dead $eflags :: (load (s64) from %stack.1)
  ; CHECK-NEXT:   MOV64mr %stack.11, 1, $noreg, 0, $noreg, [[MOV64rm1]] :: (store (s64) into %stack.11)
  ; CHECK-NEXT:   [[MOV32rm5:%[0-9]+]]:gr32 = MOV32rm %stack.10, 1, $noreg, 0, $noreg :: (load (s32) from %stack.10)
  ; CHECK-NEXT:   undef [[COPY8:%[0-9]+]].sub_32bit:gr64_nosp = COPY [[MOV32rm5]]
  ; CHECK-NEXT:   [[MOV64rm2:%[0-9]+]]:gr64 = MOV64rm %stack.8, 1, $noreg, 0, $noreg :: (load (s64) from %stack.8)
  ; CHECK-NEXT:   [[MOV64rm3:%[0-9]+]]:gr64 = MOV64rm %stack.3, 1, $noreg, 0, $noreg :: (load (s64) from %stack.3)
  ...
  ; CHECK-NEXT:   [[MOV64rm4:%[0-9]+]]:gr64 = ADD64rm [[MOV64rm4]], %stack.6, 1, $noreg, 0, $noreg, implicit-def dead $eflags :: (load (s64) from %stack.6)
  ; CHECK-NEXT:   [[MOV64rm5:%[0-9]+]]:gr64 = MOV64rm %stack.9, 1, $noreg, 0, $noreg :: (load (s64) from %stack.9)
  ; CHECK-NEXT:   ADD64mr %stack.8, 1, $noreg, 0, $noreg, [[MOV64rm5]], implicit-def dead $eflags :: (store (s64) into %stack.8)
  ; CHECK-NEXT:   MOV64mr %stack.5, 1, $noreg, 0, $noreg, [[MOV64rm4]] :: (store (s64) into %stack.5)
  ; CHECK-NEXT:   CMP64rm [[MOV64rm4]], %stack.7, 1, $noreg, 0, $noreg, implicit-def $eflags :: (load (s64) from %stack.7)
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[PTILEZEROV:%[0-9]+]]:tile = PTILEZEROV [[COPY5]].sub_16bit, [[MOV32rm2]].sub_16bit
  ; CHECK-NEXT:   [[COPY9:%[0-9]+]]:gr64 = COPY [[MOV64rm]]
  ; CHECK-NEXT:   [[MOV64rm6:%[0-9]+]]:gr64_nosp = MOV64rm %stack.2, 1, $noreg, 0, $noreg :: (load (s64) from %stack.2)
  ; CHECK-NEXT:   [[COPY10:%[0-9]+]]:gr32 = COPY [[LEA64_32r1]]
  ; CHECK-NEXT:   [[MOV64rm7:%[0-9]+]]:gr64 = MOV64rm %stack.11, 1, $noreg, 0, $noreg :: (load (s64) from %stack.11)
  ; CHECK-NEXT:   [[PTILELOADDV:%[0-9]+]]:tile = PTILELOADDV [[COPY5]].sub_16bit, [[COPY3]].sub_16bit, [[MOV64rm7]], 1, [[MOV64rm6]], 0, $noreg
  ; CHECK-NEXT:   [[LEA64_32r1:%[0-9]+]]:gr32 = COPY [[COPY10]]
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]]:gr64_nosp = MOVSX64rr32 [[COPY8]].sub_32bit
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]]:gr32 = COPY [[MOVZX32rr16_]]
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]]:gr64_nosp = COPY [[MOVSX64rr32_1]]
  ; CHECK-NEXT:   [[COPY13:%[0-9]+]]:gr64 = COPY [[LEA64r1]]
  ; CHECK-NEXT:   [[COPY14:%[0-9]+]]:gr32 = COPY [[COPY3]]
  ; CHECK-NEXT:   [[COPY15:%[0-9]+]]:gr32 = COPY [[COPY5]]
  ; CHECK-NEXT:   [[COPY16:%[0-9]+]]:gr64 = COPY [[MOVSX64rr32_3]]
  ; CHECK-NEXT:   [[COPY17:%[0-9]+]]:gr64 = COPY [[MOVSX64rr32_2]]
  ; CHECK-NEXT:   [[COPY18:%[0-9]+]]:gr64 = COPY [[MOV32rm2]]
  ; CHECK-NEXT:   [[MOV64rm8:%[0-9]+]]:gr64 = MOV64rm %stack.12, 1, $noreg, 0, $noreg :: (load (s64) from %stack.12)
  ; CHECK-NEXT:   [[LEA64r2:%[0-9]+]]:gr64 = LEA64r [[MOV64rm8]], 1, [[COPY8]], 0, $noreg
  ; CHECK-NEXT:   [[PTILELOADDV1:%[0-9]+]]:tile = PTILELOADDV [[COPY11]].sub_16bit, [[LEA64_32r1]].sub_16bit, [[LEA64r2]], 1, [[COPY12]], 0, $noreg
  ; CHECK-NEXT:   [[MOV32rm2:%[0-9]+]]:gr64_nosp = COPY [[COPY18]]
  ; CHECK-NEXT:   [[MOVSX64rr32_2:%[0-9]+]]:gr64_nosp = COPY [[COPY17]]
  ; CHECK-NEXT:   [[MOVSX64rr32_3:%[0-9]+]]:gr64_nosp = COPY [[COPY16]]
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:gr32 = COPY [[COPY15]]
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:gr32 = COPY [[COPY14]]
  ; CHECK-NEXT:   [[LEA64r1:%[0-9]+]]:gr64 = COPY [[COPY13]]
  ; CHECK-NEXT:   [[MOV64rm:%[0-9]+]]:gr64 = COPY [[COPY9]]
  ; CHECK-NEXT:   [[MOVSX64rr32_1:%[0-9]+]]:gr64 = COPY [[COPY12]]
  ; CHECK-NEXT:   [[MOVZX32rr16_:%[0-9]+]]:gr32 = COPY [[COPY11]]
  ; CHECK-NEXT:   [[PTILEZEROV:%[0-9]+]]:tile = PTDPBSSDV [[COPY5]].sub_16bit, [[LEA64_32r1]].sub_16bit, [[COPY3]].sub_16bit, [[PTILEZEROV]], [[PTILELOADDV]], [[PTILELOADDV1]]
  ; CHECK-NEXT:   PTILESTOREDV [[COPY5]].sub_16bit, [[MOV32rm2]].sub_16bit, [[MOV64rm2]], 1, [[MOVSX64rr32_2]], 0, $noreg, [[PTILEZEROV]]
  ; CHECK-NEXT:   [[MOV64rm3:%[0-9]+]]:gr64 = ADD64rr [[MOV64rm3]], [[MOVSX64rr32_3]], implicit-def dead $eflags
  ; CHECK-NEXT:   [[MOV64rm2:%[0-9]+]]:gr64 = ADD64rr [[MOV64rm2]], [[LEA64r1]], implicit-def dead $eflags
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]].sub_32bit:gr64_nosp = ADD32rr [[COPY8]].sub_32bit, [[LEA64_32r1]], implicit-def dead $eflags
  ; CHECK-NEXT:   CMP64rr [[MOV64rm3]], [[MOV64rm]], implicit-def $eflags
