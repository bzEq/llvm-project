...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_writelane_b32 v6, s4, 32
; CHECK-NEXT:    v_writelane_b32 v5, s61, 27
; CHECK-NEXT:    v_writelane_b32 v6, s5, 33
; CHECK-NEXT:    v_writelane_b32 v5, s62, 28
; CHECK-NEXT:    v_writelane_b32 v6, s6, 34
; CHECK-NEXT:    v_writelane_b32 v5, s63, 29
; CHECK-NEXT:    v_writelane_b32 v6, s7, 35
; CHECK-NEXT:    v_writelane_b32 v5, s64, 30
; CHECK-NEXT:    v_writelane_b32 v6, s8, 36
; CHECK-NEXT:    v_writelane_b32 v5, s65, 31
; CHECK-NEXT:    v_writelane_b32 v6, s9, 37
...
; CHECK-NEXT:    v_writelane_b32 v6, s10, 38
; CHECK-NEXT:    v_writelane_b32 v5, s67, 33
; CHECK-NEXT:    v_writelane_b32 v6, s11, 39
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_readlane_b32 s12, v6, 32
; CHECK-NEXT:    v_readlane_b32 s13, v6, 33
; CHECK-NEXT:    v_readlane_b32 s14, v6, 34
; CHECK-NEXT:    v_readlane_b32 s15, v6, 35
; CHECK-NEXT:    v_readlane_b32 s16, v6, 36
; CHECK-NEXT:    v_readlane_b32 s17, v6, 37
; CHECK-NEXT:    v_readlane_b32 s18, v6, 38
; CHECK-NEXT:    v_readlane_b32 s19, v6, 39
; CHECK-NEXT:    v_writelane_b32 v6, s52, 40
; CHECK-NEXT:    v_writelane_b32 v6, s53, 41
; CHECK-NEXT:    v_writelane_b32 v6, s54, 42
; CHECK-NEXT:    v_writelane_b32 v6, s55, 43
; CHECK-NEXT:    v_writelane_b32 v6, s56, 44
; CHECK-NEXT:    v_writelane_b32 v6, s57, 45
; CHECK-NEXT:    v_writelane_b32 v6, s58, 46
; CHECK-NEXT:    v_writelane_b32 v6, s59, 47
; CHECK-NEXT:    v_writelane_b32 v6, s60, 48
; CHECK-NEXT:    v_writelane_b32 v6, s61, 49
; CHECK-NEXT:    v_writelane_b32 v6, s62, 50
; CHECK-NEXT:    v_writelane_b32 v6, s63, 51
; CHECK-NEXT:    v_writelane_b32 v6, s64, 52
; CHECK-NEXT:    v_writelane_b32 v6, s65, 53
; CHECK-NEXT:    v_writelane_b32 v6, s66, 54
; CHECK-NEXT:    v_writelane_b32 v6, s67, 55
; CHECK-NEXT:    s_or_saveexec_b64 s[20:21], s[26:27]
; CHECK-NEXT:    s_mov_b64 s[58:59], s[10:11]
; CHECK-NEXT:    s_mov_b64 s[56:57], s[8:9]
; CHECK-NEXT:    s_mov_b64 s[54:55], s[6:7]
...
; CHECK-NEXT:    v_readlane_b32 s36, v6, 40
; CHECK-NEXT:    s_mov_b32 s9, s8
; CHECK-NEXT:    s_mov_b32 s10, s8
; CHECK-NEXT:    s_mov_b32 s11, s8
; CHECK-NEXT:    v_mov_b32_e32 v2, s7
; CHECK-NEXT:    v_readlane_b32 s37, v6, 41
; CHECK-NEXT:    v_readlane_b32 s38, v6, 42
; CHECK-NEXT:    v_readlane_b32 s39, v6, 43
; CHECK-NEXT:    v_readlane_b32 s40, v6, 44
; CHECK-NEXT:    v_readlane_b32 s41, v6, 45
; CHECK-NEXT:    v_readlane_b32 s42, v6, 46
; CHECK-NEXT:    v_readlane_b32 s43, v6, 47
; CHECK-NEXT:    s_nop 4
...
; CHECK-NEXT:    v_readlane_b32 s44, v6, 48
; CHECK-NEXT:    v_readlane_b32 s45, v6, 49
; CHECK-NEXT:    v_readlane_b32 s46, v6, 50
; CHECK-NEXT:    v_readlane_b32 s47, v6, 51
; CHECK-NEXT:    v_readlane_b32 s48, v6, 52
; CHECK-NEXT:    v_readlane_b32 s49, v6, 53
; CHECK-NEXT:    v_readlane_b32 s50, v6, 54
; CHECK-NEXT:    v_readlane_b32 s51, v6, 55
