...
; SOFT-NEXT:    cmp r2, #0
; SOFT-NEXT:    beq .LBB6_10
; SOFT-NEXT:  @ %bb.9:
; SOFT-NEXT:    ldr r3, .LCPI6_2
; SOFT-NEXT:  .LBB6_10:
; SOFT-NEXT:    cmp r1, #0
; SOFT-NEXT:    bne .LBB6_12
; SOFT-NEXT:  @ %bb.11:
; SOFT-NEXT:    mov r6, r3
; SOFT-NEXT:  .LBB6_12:
; SOFT-NEXT:    mov r1, r6
...
; SOFT-NEXT:    add r5, sp, #4
; SOFT-NEXT:    stm r5!, {r1, r2, r3} @ 12-byte Folded Spill
; SOFT-NEXT:    cmp r7, #0
...
; SOFT-NEXT:  @ %bb.17:
; SOFT-NEXT:    mvns r6, r4
; SOFT-NEXT:    str r6, [sp, #12] @ 4-byte Spill
; SOFT-NEXT:  .LBB8_18:
...
; SOFT-NEXT:    movs r5, #0
; SOFT-NEXT:    mvns r1, r5
; SOFT-NEXT:    str r4, [sp, #12] @ 4-byte Spill
; SOFT-NEXT:    cmp r4, #0
...
; SOFT-NEXT:    cmp r1, #0
; SOFT-NEXT:    beq .LBB12_4
; SOFT-NEXT:  @ %bb.3:
; SOFT-NEXT:    ldr r0, .LCPI12_3
; SOFT-NEXT:  .LBB12_4:
; SOFT-NEXT:    mov r7, r0
; SOFT-NEXT:    mov r0, r6
; SOFT-NEXT:    mov r1, r5
...
; SOFT-NEXT:    ldr r1, [sp] @ 4-byte Reload
; SOFT-NEXT:    cmp r1, #0
; SOFT-NEXT:    beq .LBB13_4
; SOFT-NEXT:  @ %bb.3:
; SOFT-NEXT:    ldr r0, .LCPI13_3
; SOFT-NEXT:  .LBB13_4:
; SOFT-NEXT:    mov r7, r0
; SOFT-NEXT:    mov r0, r6
; SOFT-NEXT:    mov r1, r5
...
; SOFT-NEXT:    ldr r1, [sp] @ 4-byte Reload
; SOFT-NEXT:    cmp r1, #0
; SOFT-NEXT:    beq .LBB14_4
; SOFT-NEXT:  @ %bb.3:
; SOFT-NEXT:    ldr r0, .LCPI14_3
; SOFT-NEXT:  .LBB14_4:
; SOFT-NEXT:    mov r7, r0
; SOFT-NEXT:    mov r0, r6
; SOFT-NEXT:    mov r1, r5
...
; SOFT-NEXT:    cmp r2, #0
; SOFT-NEXT:    beq .LBB16_10
; SOFT-NEXT:  @ %bb.9:
; SOFT-NEXT:    ldr r3, .LCPI16_2
; SOFT-NEXT:  .LBB16_10:
; SOFT-NEXT:    cmp r1, #0
; SOFT-NEXT:    bne .LBB16_12
; SOFT-NEXT:  @ %bb.11:
; SOFT-NEXT:    mov r4, r3
; SOFT-NEXT:  .LBB16_12:
; SOFT-NEXT:    mov r1, r4
...
; SOFT-NEXT:    ldr r2, [sp] @ 4-byte Reload
; SOFT-NEXT:    cmp r2, #0
; SOFT-NEXT:    beq .LBB26_10
; SOFT-NEXT:  @ %bb.9:
; SOFT-NEXT:    ldr r3, .LCPI26_2
; SOFT-NEXT:  .LBB26_10:
; SOFT-NEXT:    cmp r1, #0
; SOFT-NEXT:    bne .LBB26_12
; SOFT-NEXT:  @ %bb.11:
; SOFT-NEXT:    mov r6, r3
; SOFT-NEXT:  .LBB26_12:
; SOFT-NEXT:    mov r1, r6
